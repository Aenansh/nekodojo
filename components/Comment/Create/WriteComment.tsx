  ...
  return (
    <div className="flex gap-4 w-full mb-8 animate-in fade-in slide-in-from-bottom-2">
      ...
      <div className="flex-1 space-y-3">
        <div
          className={`relative transition-all duration-200 ${isFocused ? "opacity-100" : "opacity-80 hover:opacity-100"}`}
        >
          <Textarea
          ...
          />
          <div
            className={`absolute bottom-0 left-0 h-px bg-[#d4af37] transition-all duration-300 ${isFocused ? "w-full" : "w-0"}`}
          />
        </div>
        {post && (
