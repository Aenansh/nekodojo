  ...
  return (
    <>
      <div
        ...
        style={{
          // Using a subtle repeating wood pattern over the dark background color
      ...
      >
        ...
        >
          ...
          {/* Top Decorative Wood Beam (Slightly Darker) */}
          ...
          <div className="p-8 space-y-8 relative z-10">
            ...
            <div className="space-y-2">
              {/* Added text-shadow for gold leaf effect */}
            ...
            {/* Illustration Container (Inset "Carved" Look) */}
            ...
            {/* Action Button (Gold accent) */}
            <Link href="/" className="block">
              <Button className="bg-linear-to-b from-[#3e2723] to-[#2d1b15] text-[#d4af37] hover:from-[#d4af37] hover:to-[#b5952f] hover:text-[#1a110d] border-2 border-[#d4af37]/30 transition-all duration-300 font-bold px-10 py-6 text-lg shadow-[0_10px_20px_-10px_rgba(0,0,0,0.8)] hover:shadow-[0_10px_25px_-5px_rgba(212,175,55,0.4)] hover:-translate-y-1 group relative overflow-hidden">
